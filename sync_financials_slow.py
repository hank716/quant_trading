...
def parse_args() -> argparse.Namespace:
    ...
    _cache = os.getenv("CACHE_DIR", ".cache")
    parser.add_argument("--cursor-file", default=os.path.join(_cache, "finmind", "financial_sync_cursor.json"))
    parser.add_argument("--official-cache-dir", default=os.path.join(_cache, "official_hybrid"))
    parser.add_argument("--cache-dir", default=os.path.join(_cache, "finmind"))
